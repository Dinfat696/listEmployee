...
public class EmployeeController {
    ...
    public String addEmployeeInfo(@RequestParam("firstName") String firstName,@RequestParam("lastName") String lastName){
        try {
            ...
            return "Невозможно добавить сутридника. Сотрудник уже есть.";
        }
